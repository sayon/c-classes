...
#define CLASS_NAME( DESCR ) DESCR( ID, SKIP1, SKIP3, SKIP3, SKIP1, SKIP1 )
#define PARENT_NAME( DESCR ) DESCR( SKIP1, ID, SKIP3, SKIP3, SKIP1, SKIP1 )

#define FOR_PUBLIC_FIELDS( DESCR, DO ) DESCR( SKIP1, SKIP1, DO, SKIP3, SKIP1, SKIP1 )
#define FOR_PRIVATE_FIELDS( DESCR, DO ) DESCR( SKIP1, SKIP1, SKIP3, DO, SKIP1, SKIP1 )

#define FOR_PUBLIC_METHODS( DESCR, DO ) DESCR( SKIP1, SKIP1, SKIP3, SKIP3, DO, SKIP1 )
#define FOR_PRIVATE_METHODS( DESCR, DO ) DESCR( SKIP1, SKIP1, SKIP3, SKIP3, SKIP1, DO )
