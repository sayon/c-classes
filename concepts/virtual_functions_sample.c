...
void Parent_init(Parent* this, int value) { ((Object*)this)->vtable = &Parent_vtable; this->value = value; } 
Parent* Parent_alloc(int value) { Parent* instance; instance = malloc( sizeof( Parent ) ); Parent_init( instance, value ); return instance; }
...
void Child_init(Child* this, int value) { Parent_init( & this->base, 999 ); ((Object*)this)->vtable = &Child_vtable; this->value = value; }
Child* Child_alloc(int value) { Child* instance; instance = malloc( sizeof( Child ) ); Child_init( instance, value ); return instance; }
